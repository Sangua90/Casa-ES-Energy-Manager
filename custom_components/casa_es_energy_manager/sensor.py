...
SENSORS = (
    ...
    CasaESSensorDescription(key="ai_status", name="Stato pianificatore AI"),
    CasaESSensorDescription(key="ai_strategy", name="Strategia AI finale"),
    CasaESSensorDescription(key="ai_raw_strategy", name="Strategia AI originale"),
    ...
    CasaESSensorDescription(key="forecast_energy_to_target_kwh", name="FV previsto fino all'obiettivo", **_ENERGY),
