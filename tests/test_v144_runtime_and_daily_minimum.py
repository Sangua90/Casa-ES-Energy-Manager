...
class RuntimePersistenceContractTests(unittest.TestCase):
    ...
    def test_v155_retains_v154_v153_v152_v151_v15_and_v144_chain(self) -> None:
        ...
        self.assertIn("from .coordinator_v154 import CasaESEnergyCoordinator as V154Coordinator", source155)
        self.assertIn("class CasaESEnergyCoordinator(V154Coordinator)", source155)
        self.assertIn("from .coordinator_v155 import CasaESEnergyCoordinator", init_source)
    ...
    def test_version_is_155(self) -> None:
